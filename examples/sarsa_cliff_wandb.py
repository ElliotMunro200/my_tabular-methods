...
gw.add_transition_probability(p_good_transition=0.5,
                              bias=0)
gw.add_discount(discount=0.9)
model = gw.create_gridworld()

run_config = {"group": "SARSA", "goal_reward": 10}
wandb_init(extra_config=run_config)

# solve with SARSA
q_function, pi, state_counts = sarsa(model, alpha=0.1, epsilon=0.2, maxiter=100, maxeps=10000)
